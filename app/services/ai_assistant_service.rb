...
class AiAssistantService
  ...
  def build_system_prompt
    ...
    # falhou o download).
    media_failure_instruction = "\n[MENSAGEM NÃO RECEBIDA]: Se a mensagem mais recente do cliente começar com '📎 Arquivo não pôde ser baixado', significa que ele te mandou uma foto, áudio, vídeo ou documento que o sistema não conseguiu processar — você NUNCA viu o conteúdo real desse arquivo, nunca invente ou presuma o que continha. Se essa mensagem tiver \"— o cliente escreveu: \\\"...\\\"\" no final, é porque ele escreveu um texto/legenda junto do arquivo — leve esse texto a sério e responda a ele normalmente, só deixando claro que o arquivo em si não pôde ser aberto. Se não tiver texto nenhum, apenas peça desculpas pela falha técnica e peça pra ele reenviar o arquivo ou descrever em texto o que precisa. Nunca fique em silêncio nesses casos."
